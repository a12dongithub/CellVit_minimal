...
if [ ! -d "$ENV_DIR" ]; then
    ...
    python -m pip install torch==2.2.2+cu118 torchvision==0.17.2+cu118 torchaudio==2.2.2+cu118 --index-url https://download.pytorch.org/whl/cu118 --no-cache-dir
    python -m pip install "cupy-cuda11x<14.0.0"
