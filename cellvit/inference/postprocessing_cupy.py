...
def conditional_remote_actor(cls):
    if ray is not None:
        return ray.remote(num_cpus=1, num_gpus=0.1)(cls)
    return cls


@conditional_remote_actor
class BatchPoolingActor:
    ...
    def convert_batch_to_graph_nodes(
        ...
        if "tokens" in predictions and predictions["tokens"] is not None:
        ...
        for idx, (patch_cell_dict, patch_metadata) in enumerate(
            ...
            (
                ...
                patch_cell_dict, patch_metadata, patch_token
            )
